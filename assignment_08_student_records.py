...
def add_student(students):
    """Prompt for a student's name, ID, and scores, then add the record."""
...
def format_score(score):
    """Format a score without a trailing .0 when it's a whole number."""
    return str(int(score)) if flot(score).is_integer() else str(score)
def display_menu():
